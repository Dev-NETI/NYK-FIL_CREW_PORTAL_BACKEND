...
<head>
  ...
  <title>Appointment Created - NYK-FIL Crew Portal</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .logo-icon { font-size: 40px; color: #ffffff; }
    .header h1 {
      color: #ffffff;
      font-size: 28px;
      font-weight: 700;
...
<body>
  <div class="email-wrapper">
    ...
    <div class="content">
      <div class="greeting">Appointment Created</div>

      <div class="message">
        This is a confirmation that an appointment has been scheduled.
      </div>

      <div class="app-badge">📱 NYK-FIL SUPER APP</div>
      ...
      <div class="info-box">
        ...
        <div class="info-value">
          <strong>Crew:</strong>
          {{ $crew?->name ?? 'N/A' }}
          @if(!empty($crew?->email)) ({{ $crew->email }}) @endif
        </div>

        <div class="info-value">
          <strong>Department:</strong>
          {{ $department?->name ?? 'N/A' }}
          @if(!empty($department?->email)) ({{ $department->email }}) @endif
        </div>

        <div class="info-value">
          <strong>Appointment Type:</strong> {{ $appointment->type?->name ?? 'N/A' }}
        </div>
      ...
      <div class="message" style="margin-top: 24px; font-size: 14px; color: #6b7280;">
        If you did not request this appointment, please contact the department immediately.
      </div>
    </div>
