...
<head>
  ...
  <title>Appointment Confirmed - NYK-FIL Crew Portal</title>
...
<body>
  <div class="email-wrapper">
    ...
    <div class="content">
      ...
      <div class="message">
        Your appointment has been confirmed. Please arrive on time and bring any required documents.
      </div>
      ...
      <div class="message" style="margin-top: 24px; font-size: 14px; color: #6b7280;">
        Contact the department if you need to reschedule.
      </div>
    </div>
