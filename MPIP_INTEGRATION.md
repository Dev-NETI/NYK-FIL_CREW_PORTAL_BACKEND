...
- *(Outbound endpoint — to be implemented)*
...
```json
{
  ...
  "details": {
    ...
    "skipped": [
      { "email": "unknown@example.com", "reason": "No crew member found with this email." }
    ],
    "errors": []
  }
}
...
```json
{
  ...
  "errors": {
    "crew.0.profile.first_name": ["The crew.0.profile.first_name field is required when crew.0.profile is present."]
  }
}
```
...
```json
{
  ...
  "message": "Validation failed.",
  "errors": {
    "contracts.0.contract_start_date": ["The contracts.0.contract_start_date field is required."]
  }
}
```
